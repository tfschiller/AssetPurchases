...
ggplot(InflationExpectations)+ 
  ...
  theme(axis.title=element_text(size=8), axis.text=element_text(size=8))+
  ggtitle("Figure 3: US Inflation Expectations")+theme(plot.title = element_text(size=9, face = "bold"))+
...
ggplot(MedianSalesPriceHouses)+ 
  ...
  theme(axis.title=element_text(size=8), axis.text=element_text(size=8))+
  ggtitle("Figure 4: Median Sales Price of Houses Sold for the United States")+theme(plot.title = element_text(size=9, face = "bold"))+
  theme(
    panel.grid.major.x = element_blank() ,
    panel.grid.major.y = element_line( size=.3, color="grey" ))+
  theme(axis.ticks.y = element_blank())+
...
ggplot(TenYearTreasuryConstantMaturity)+ 
  ...
  scale_y_continuous(labels=comma, name="Percent", breaks = scales::pretty_breaks(n = 10))+
  theme(axis.title=element_text(size=8), axis.text=element_text(size=8))+
  ggtitle("Figure 5: 10-Year Treasury Constant Maturity Rate")+theme(plot.title = element_text(size=9, face = "bold"))+
...
ggplot(Wilshire5000)+ 
  ...
  theme(axis.title=element_text(size=8), axis.text=element_text(size=8))+
  ggtitle("Figure 6: Wilshire 5000 Full Cap Price Index")+theme(plot.title = element_text(size=9, face = "bold"))+
  theme(panel.grid.major.x = element_blank() ,
        panel.grid.major.y = element_line( size=.3, color="grey" ))+
  theme(axis.ticks.y = element_blank())+
  labs(caption="Source: FRED")
